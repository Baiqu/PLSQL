(function ($) {
    ...
    $.jqPaginator = function (el, options) {
        ...
        self.renderHtml = function () {
            ...
            self.isEnable('loadText') && html.push(self.buildItem('loadText', self.options.totalCounts));
        ...
        self.ajax = function (pageIndex) {
            ...
            $(".loadText").show();
            //执行分页前事件
            if (self.options.onPageChange != undefined) {
            ...
            $.ajax({
                ...
                complete: function (xml, status) {
                    $(".loadText").hide();
                    //执行分页前事件
                    if (self.options.onComplete != undefined) {
    ...
    $.jqPaginator.defaultOptions = {
        ...
        totalPagesText: '<li class="am-disabled"><a href="javascript:;">共{{totalPages}}页</a></li>',
        totalCountsText: '<li class="am-disabled"><a href="javascript:;">共{{totalCounts}}条</a></li>',
        loadText: '<li class="am-disabled loadText" style="display:none;color:red"><i class="am-icon-refresh am-icon-spin"></i> 加载中</li>',
        tip: 'view-tip',
        totalPages: 0,
        totalCounts: 0,
        pageSize: 0,
